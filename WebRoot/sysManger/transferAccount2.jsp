...
<script type="text/javascript">
      ...
      function f_change()
      {
    	  ...
    	  var actionURL = "cardNumberQueryAction?cardNumber="+cardNumber+"&passWord="+passWord;
    	  var count = 0;
      		$.ajax({
				type:"POST",
				url:actionURL,
      		...
      		if(count == 0)
      			{
      				$.ligerDialog.error('用户名或密码错误,请核实后重新输入');
      				$("#cardNumber").val("");
      				$("#passWord").val("");
      			}
      ...
      $.ajax({   
              url :'transferAccountMoneyAction',  //后台处理程序   
             type:'post',    //数据发送方式   
...
<body style="padding:10px">
	...
	<form name="form1" method="post" action="" id="form1">
		...
		<table cellpadding="0" cellspacing="0" class="l-table-edit"
			width="100%">
			<tr>
				<td align="right" class="l-table-edit-td"><font color="#ff0000">*</font>请输入转入的卡号:</td>
				<td align="left" class="l-table-edit-td"><input
					name="cardNumber" type="text" id="cardNumber" ltype="text"
			...
			<tr>
				<td align="right" class="l-table-edit-td"><font color="#ff0000">*</font>输入转账的钱数:</td>
				<td align="left" class="l-table-edit-td"><input
